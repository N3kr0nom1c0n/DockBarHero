...
| `volume1-level20-context-safe.png` | `volume1-level20-safe.png` | `exec-fc9dd2ab-6238-4f1b-88d7-f57aa8836da0.png` | Wide fully clothed adult demon on tiny couch with listening clinician; medium doorway referral handoff from adult Mercy; extreme close-up of clinician's many-eyed writing hand with blurred demon; top-down cursed-crown intake; macro closed unlabeled supervised-medication container; hallway-wide physical Book outside the closed therapy door. Generated in RTL order; no story substitutions. | 1536x1024 | PASS review fix: six visually distinct square cells and camera treatments, clean gutters, stable safe adults, no duplicate couch/writing composition, no lettering/logo/watermark. |
