...
| `shatteredSeven` | `slot1 (0.650,0.015,0.335,0.220)`; `slot2 (0.440,0.247,0.545,0.660)`; `slot3 (0.015,0.015,0.623,0.220)`; `slot4 (0.015,0.247,0.413,0.200)`; `slot5 (0.015,0.459,0.413,0.200)`; `slot6 (0.227,0.671,0.201,0.314)`; `slot7 (0.015,0.671,0.200,0.314)` |
